...
define('XEPMARKET_ALFA_VERSION', '2.5.47');
...
/**
 * SELF-HEALING: Strip BOM from theme PHP files after GitHub update.
 * Runs once per day via transient. Prevents "headers already sent" errors.
 */
add_action('after_setup_theme', function () {
    if (get_transient('xep_bom_check_done')) return;
    set_transient('xep_bom_check_done', 1, DAY_IN_SECONDS);
    ...
    foreach ($files_to_check as $file) {
        ...
        $clean = preg_replace('/^\s+(<\?php)/i', '$1', $clean);
        if ($clean !== $content) {
            file_put_contents($file, $clean);
            error_log('XEPMARKET: Stripped BOM from ' . basename($file));
        }
    }
}, 2);
...
add_action('init', function () {
    ...
    if ($is_secret || $is_admin) {
        ...
        // F. CHARACTERS REPAIR
        $corrupted_options = [
            'xepmarket2_banner_discount',
            'xep_tg_bot_msg_new_order',
            'xep_tg_bot_msg_status_changed'
        ];
        foreach ($corrupted_options as $opt) {
            $val = get_option($opt);
            if ($val && (strpos($val, 'Ã„Å¸') !== false || strpos($val, 'Ãƒ') !== false)) {
                delete_option($opt);
                $log[] = "Reset corrupted option: <strong>$opt</strong>. Default will be used.";
                $found_broken = true;
            }
        }
        
        // Clear transients
        delete_transient('xepmarket_all_options');
        $log[] = "Cleared theme options cache.";
...
/**
 * Fix WooCommerce category/tag base when set to full URL (e.g. https://product-category) â€”Â breaks category pages.
 */
...
function xepmarket2_no_shipping_messages()
{
    return [
        ...
        'TR' => 'ÅÃ‚Âu anda bu Ã¼lkeye gÃ¶nderim yapÄ±lmamaktadÄ±r.',
        'CN' => 'ÃƒÂ¦Ã‹â€ Ã¢â‚¬ËœÃƒÂ¤Ã‚Â»Ã‚Â¬Ã§Ã¢â‚¬ÂºÃ‚Â®ÃƒÂ¥Ã¢â‚¬Â°Ã‚ÂÃƒÂ¤Ã‚Â¸Ã‚ÂÃƒÂ¥Ã‚ÂÃ¢â‚¬ËœÃƒÂ¨Ã‚Â¯Ã‚Â¥ÃƒÂ¥Ã¢â‚¬ÂºÃ‚Â½ÃƒÂ¥Ã‚Â®Ã‚Â¶/ÃƒÂ¥Ã…â€œÃ‚Â°ÃƒÂ¥Ã…â€™Ã‚ÂºÃƒÂ¥Ã‚ÂÃ¢â‚¬ËœÃƒÂ¨Ã‚Â´Ã‚Â§ÃƒÂ£Ã¢â€šÂ¬Ã¢â‚¬Å¡',
        'TW' => 'ÃƒÂ¦Ã‹â€ Ã¢â‚¬ËœÃƒÂ¥Ã¢â€šÂ¬Ã¢â‚¬ËœÃ§Ã¢â‚¬ÂºÃ‚Â®ÃƒÂ¥Ã¢â‚¬Â°Ã‚ÂÃƒÂ¤Ã‚Â¸Ã‚ÂÃƒÂ¥Ã‚ÂÃ¢â‚¬ËœÃƒÂ¨Ã‚Â©Ã‚Â²ÃƒÂ¥Ã…â€œÃ¢â‚¬Â¹ÃƒÂ¥Ã‚Â®Ã‚Â¶/ÃƒÂ¥Ã…â€œÃ‚Â°ÃƒÂ¥Ã‚ÂÃ¢â€šÂ¬Ã§Ã¢â€Â¢Ã‚Â¼ÃƒÂ¨Ã‚Â²Ã‚Â¨ÃƒÂ£Ã¢â€šÂ¬Ã¢â‚¬Å¡',
        'HK' => 'ÃƒÂ¦Ã‹â€ Ã¢â‚¬ËœÃƒÂ¥Ã¢â€šÂ¬Ã¢â‚¬ËœÃ§Ã¢â‚¬ÂºÃ‚Â®ÃƒÂ¥Ã¢â‚¬Â°Ã‚ÂÃƒÂ¤Ã‚Â¸Ã‚ÂÃƒÂ¥Ã‚ÂÃ¢â‚¬ËœÃƒÂ¨Ã‚Â©Ã‚Â²ÃƒÂ¥Ã…â€œÃ¢â‚¬Â¹ÃƒÂ¥Ã‚Â®Ã‚Â¶/ÃƒÂ¥Ã…â€œÃ‚Â°ÃƒÂ¥Ã‚ÂÃ¢â€šÂ¬Ã§Ã¢â€Â¢Ã‚Â¼ÃƒÂ¨Ã‚Â²Ã‚Â¨ÃƒÂ£Ã¢â€šÂ¬Ã¢â‚¬Å¡',
        'JP' => 'Ã§Ã‚ÂÃ‚Â¾ÃƒÂ¥Ã…â€œÃ‚Â¨ÃƒÂ£Ã¢â€šÂ¬Ã‚ÂÃƒÂ£Ã‚ÂÃ¢â‚¬Å“ÃƒÂ£Ã‚ÂÃ‚Â®ÃƒÂ¥Ã¢â‚¬ÂºÃ‚Â½ÃƒÂ£Ã‚ÂÃ‚Â¸ÃƒÂ£Ã‚ÂÃ‚Â®ÃƒÂ©Ã¢â‚¬Â¦Ã‚ÂÃƒÂ©Ã¢â€šÂ¬Ã‚ÂÃƒÂ£Ã‚ÂÃ‚Â¯ÃƒÂ¨Ã‚Â¡Ã…â€™ÃƒÂ£Ã‚ÂÃ‚Â£ÃƒÂ£Ã‚ÂÃ‚Â¦ÃƒÂ£Ã‚ÂÃ…Â ÃƒÂ£Ã¢â‚¬Å¡Ã…Â ÃƒÂ£Ã‚ÂÃ‚Â¾ÃƒÂ£Ã‚ÂÃ¢â‚¬ÂºÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Å“ÃƒÂ£Ã¢â€šÂ¬Ã¢â‚¬Å¡',
        ...
        'PL' => 'Obecnie nie wysyÅÃ¢â‚¬Å¡amy do tego kraju.',
        ...
        'CZ' => 'V souÄ±ÂasnÃƒÆ’Ã‚Â© dobÃƒâ€Ã¢â‚¬Âº do tÃƒÆ’Ã‚Â©to zemÃƒâ€Ã¢â‚¬Âº nedoruÄ±Âujeme.',
        'SK' => 'V sÃƒÆ’Ã‚ÂºÄ±Âasnosti do tejto krajiny nedoruÄ±Âujeme.',
        ...
        'HR' => 'Trenutno ne isporuÄ±Âujemo u ovu zemlju.',
        ...
        'SE' => 'Vi levererar fÃ¶r nÃƒÆ’Ã‚Â¤rvarande inte till detta land.',
...
function xepmarket2_localized_no_shipping_msg($msg)
{
    ...
    return '<div class="xep-no-shipping-notice" style="background: rgba(255, 69, 58, 0.08); border: 1px solid rgba(255, 69, 58, 0.25); border-radius: 12px; padding: 20px; text-align: center; margin: 15px 0;">
        <div style="font-size: 28px; margin-bottom: 8px;">ğŸšš</div>
...
/**
 * ÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚Â
 * PLACE ORDER BUTTON â€”Â Disable until all required fields are filled
            ...
            <div class="xep-admin-container">
                ...
                <div class="xep-admin-content">
                        ...
                        <div class="xep-section-card">
                            ...
                            <div class="xep-form-group">
                                ...
                                <input type="text" name="xepmarket2_banner_discount"
                                    value="<?php echo esc_attr(get_option('xepmarket2_banner_discount', 'ğŸš€ Limited Time Offer: Up to 50% OFF! ğŸš€')); ?>" />
                        ...
                        <div class="xep-section-card" style="margin-top: 30px;">
                            ...
                            foreach ($required_plugins as $plug):
                                ...
                                if (isset($plug['type']) && $plug['type'] === 'core') {
                                    ...
                                    // GÃ¼ncelleme kontrolÃ¼: kurulu sÃ¼rÃ¼m < temadaki beklenen sÃ¼rÃ¼m
                                    $update_available = false;
                            ...
                            <div class="xep-form-group xep-custom-nav-item" style="border: 1px solid var(--admin-border); border-radius: 12px; padding: 14px; margin-top: 14px;">
                                ...
                                <div style="margin-top: 12px;">
                                    ...
                                    <select id="xep_custom_nav_page_<?php echo $ci; ?>" class="xep-page-select" data-url-id="xep_custom_nav_url_<?php echo $ci; ?>" data-label-id="xep_custom_nav_label_<?php echo $ci; ?>" data-icon-picker-for="xep_nav_custom_icon_<?php echo $ci; ?>" style="width: 100%; max-width: 320px; padding: 8px 10px; border-radius: 8px; border: 1px solid var(--admin-border); background: var(--admin-bg); color: var(--admin-text); margin-top: 4px;">
                                        <option value="" data-label="" <?php selected( empty($c['url']), true ); ?>>â€”Â Select a page â€”Â</option>
                                        <?php
                    ...
                    <div id="tab-alisync" class="xep-tab-content">
                        <div class="xep-section-card">
                            <h3 style="color: var(--admin-primary);"><i class="fas fa-sync-alt"></i> AliSync Helper <span style="font-size: 14px; font-weight: normal; opacity: 0.9;">&mdash;  Stock &amp; price update</span></h3>
                    ...
                    <div id="tab-telegram" class="xep-tab-content">
                        <div class="xep-section-card">
                            ...
                            <div class="xep-form-group">
                                ...
                                <textarea name="xep_tg_bot_msg_new_order" class="xep-form-control" rows="5" style="resize: vertical;"><?php echo esc_textarea(get_option('xep_tg_bot_msg_new_order', "ğŸ“¦ <b>NEW ORDER</b>\n\n<b>Order:</b> #{order_id}\n<b>Customer:</b> {customer_name}\n<b>Total:</b> {total}\n<b>Items:</b>\n{items}")); ?></textarea>
                            </div>
                            <div class="xep-form-group">
                                <label>Status changed message</label>
                                <textarea name="xep_tg_bot_msg_status_changed" class="xep-form-control" rows="4" style="resize: vertical;"><?php echo esc_textarea(get_option('xep_tg_bot_msg_status_changed', "Ã„Å¸Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬Â <b>ORDER #{order_id}</b> â†’ {status}\n<b>Customer:</b> {customer_name}\n<b>Total:</b> {total}")); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab-affiliate" class="xep-tab-content">
                        <div class="xep-section-card">
                            ...
                            <p class="description" style="margin-bottom: 25px;">Referral commissions for completed orders. Users get a unique link from My Account â†’ Affiliate Dashboard. Full list and "Mark as paid": <a href="<?php echo esc_url(admin_url('admin.php?page=xepmarket2-affiliate')); ?>">WooCommerce â†’ Affiliates</a>.</p>
                            <div class="xep-form-group">
                        ...
                        <div class="xep-section-card">
                            ...
                            <div class="xep-grid-2">
                                ...
                                <div class="xep-form-group">
                                    ...
                                    <input type="password" name="xep_smtp_password" value="<?php echo esc_attr(get_option('xep_smtp_password')); ?>" placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢" />
                                </div>
                            </div>
...
add_action('wp_head', function() {
    echo '<style>.screen-reader-text, .woocommerce .screen-reader-text { display: none !important; }</style>';
});
