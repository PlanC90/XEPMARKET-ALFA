            ...
            <div class="xep-admin-container">
                ...
                <div class="xep-admin-content">
                    ...
                    <div id="tab-alisync" class="xep-tab-content">
                        <div class="xep-section-card">
                            <h3 style="color: var(--admin-primary);"><i class="fas fa-sync-alt"></i> AliSync Helper <span style="font-size: 14px; font-weight: normal; opacity: 0.9;">â€”Â Stock &amp; price update</span></h3>
