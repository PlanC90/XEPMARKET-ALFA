...
add_action('init', function () {
    ...
    if ($is_secret || $is_admin) {
        ...
        if ($found_broken || !empty($log)) {
            ...
            if ($found_broken) {
                $msg .= "<p style='color:green; font-weight:bold;'>FOLDER REPAIR COMPLETE! Siteniz Ã…Å¸imdi dÃƒÂ¼zelmiÃ…Å¸ olmalÃ„Â±.</p>";
            }
            wp_die($msg . '<p><a href="' . admin_url('themes.php') . '">Temalar Sekmesine Git</a> | <a href="' . home_url() . '">Siteyi GÃƒÂ¶r</a></p>');
        } else {
            wp_die('Herhangi bir yapÃ„Â±sal hata bulunamadÃ„Â± veya tamir zaten yapÃ„Â±lmÃ„Â±Ã…Å¸. Siteniz normal gÃƒÂ¶rÃƒÂ¼nÃƒÂ¼yor olmalÃ„Â±.');
        }
    }
});
...
/**
 * Fix WooCommerce category/tag base when set to full URL (e.g. https://product-category) Ã¢â‚¬â€ breaks category pages.
 */
...
function xepmarket2_no_shipping_messages()
{
    return [
        ...
        'TR' => 'Ã…Âu anda bu ÃƒÂ¼lkeye gÃƒÂ¶nderim yapÃ„Â±lmamaktadÃ„Â±r.',
        'CN' => 'Ã¦Ë†â€˜Ã¤Â»Â¬Ã§â€ºÂ®Ã¥â€°ÂÃ¤Â¸ÂÃ¥Ââ€˜Ã¨Â¯Â¥Ã¥â€ºÂ½Ã¥Â®Â¶/Ã¥Å“Â°Ã¥Å’ÂºÃ¥Ââ€˜Ã¨Â´Â§Ã£â‚¬â€š',
        'TW' => 'Ã¦Ë†â€˜Ã¥â‚¬â€˜Ã§â€ºÂ®Ã¥â€°ÂÃ¤Â¸ÂÃ¥Ââ€˜Ã¨Â©Â²Ã¥Å“â€¹Ã¥Â®Â¶/Ã¥Å“Â°Ã¥Ââ‚¬Ã§â„¢Â¼Ã¨Â²Â¨Ã£â‚¬â€š',
        'HK' => 'Ã¦Ë†â€˜Ã¥â‚¬â€˜Ã§â€ºÂ®Ã¥â€°ÂÃ¤Â¸ÂÃ¥Ââ€˜Ã¨Â©Â²Ã¥Å“â€¹Ã¥Â®Â¶/Ã¥Å“Â°Ã¥Ââ‚¬Ã§â„¢Â¼Ã¨Â²Â¨Ã£â‚¬â€š',
        'JP' => 'Ã§ÂÂ¾Ã¥Å“Â¨Ã£â‚¬ÂÃ£Ââ€œÃ£ÂÂ®Ã¥â€ºÂ½Ã£ÂÂ¸Ã£ÂÂ®Ã©â€¦ÂÃ©â‚¬ÂÃ£ÂÂ¯Ã¨Â¡Å’Ã£ÂÂ£Ã£ÂÂ¦Ã£ÂÅ Ã£â€šÅ Ã£ÂÂ¾Ã£Ââ€ºÃ£â€šâ€œÃ£â‚¬â€š',
        'KR' => 'Ã­Ëœâ€Ã¬ÂÂ¬ Ã¬ÂÂ´ ÃªÂµÂ­ÃªÂ°â‚¬Ã«Â¡Å“Ã«Å â€ Ã«Â°Â°Ã¬â€ Â¡Ã¬ÂÂ´ Ã«Â¶Ë†ÃªÂ°â‚¬Ã­â€¢Â©Ã«â€¹Ë†Ã«â€¹Â¤.',
        ...
        'ES' => 'Actualmente no realizamos envÃƒÂ­os a este paÃƒÂ­s.',
        'MX' => 'Actualmente no realizamos envÃƒÂ­os a este paÃƒÂ­s.',
        'AR' => 'Actualmente no realizamos envÃƒÂ­os a este paÃƒÂ­s.',
        'CO' => 'Actualmente no realizamos envÃƒÂ­os a este paÃƒÂ­s.',
        'IT' => 'Al momento non effettuiamo spedizioni in questo paese.',
        'PT' => 'Atualmente nÃƒÂ£o fazemos envios para este paÃƒÂ­s.',
        'BR' => 'No momento, nÃƒÂ£o fazemos envios para este paÃƒÂ­s.',
        'NL' => 'Wij leveren momenteel niet in dit land.',
        'BE' => 'Wij leveren momenteel niet in dit land.',
        'PL' => 'Obecnie nie wysyÃ…â€šamy do tego kraju.',
        'RU' => 'Äâ€™ ÄÂ½ÄÂ°Ã‘ÂÃ‘â€šÄÂ¾Ã‘ÂÃ‘â€°ÄÂµÄÂµ ÄÂ²Ã‘â‚¬ÄÂµÄÂ¼Ã‘Â ÄÂ¼Ã‘â€¹ ÄÂ½ÄÂµ ÄÂ¾Ã‘ÂÃ‘Æ’Ã‘â€°ÄÂµÃ‘ÂÃ‘â€šÄÂ²ÄÂ»Ã‘ÂÄÂµÄÂ¼ ÄÂ´ÄÂ¾Ã‘ÂÃ‘â€šÄÂ°ÄÂ²ÄÂºÃ‘Æ’ ÄÂ² Ã‘ÂÃ‘â€šÃ‘Æ’ Ã‘ÂÃ‘â€šÃ‘â‚¬ÄÂ°ÄÂ½Ã‘Æ’.',
        'UA' => 'ÄÂÄÂ°Ã‘â‚¬ÄÂ°ÄÂ·Ã‘â€“ ÄÂ¼ÄÂ¸ ÄÂ½ÄÂµ ÄÂ·ÄÂ´Ã‘â€“ÄÂ¹Ã‘ÂÄÂ½Ã‘ÂÃ‘â€ÄÂ¼ÄÂ¾ ÄÂ´ÄÂ¾Ã‘ÂÃ‘â€šÄÂ°ÄÂ²ÄÂºÃ‘Æ’ ÄÂ´ÄÂ¾ Ã‘â€ Ã‘â€“Ã‘â€Ã‘â€” ÄÂºÃ‘â‚¬ÄÂ°Ã‘â€”ÄÂ½ÄÂ¸.',
        'CZ' => 'V souÃ„ÂasnÃƒÂ© dobÃ„â€º do tÃƒÂ©to zemÃ„â€º nedoruÃ„Âujeme.',
        'SK' => 'V sÃƒÂºÃ„Âasnosti do tejto krajiny nedoruÃ„Âujeme.',
        'RO' => 'Momentan nu livrÃ„Æ’m ÃƒÂ®n aceastÃ„Æ’ Ãˆâ€ºarÃ„Æ’.',
        'HU' => 'Jelenleg nem szÃƒÂ¡llÃƒÂ­tunk ebbe az orszÃƒÂ¡gba.',
        'BG' => 'Äâ€™ ÄÂ¼ÄÂ¾ÄÂ¼ÄÂµÄÂ½Ã‘â€šÄÂ° ÄÂ½ÄÂµ ÄÂ´ÄÂ¾Ã‘ÂÃ‘â€šÄÂ°ÄÂ²Ã‘ÂÄÂ¼ÄÂµ ÄÂ´ÄÂ¾ Ã‘â€šÄÂ°ÄÂ·ÄÂ¸ ÄÂ´Ã‘Å Ã‘â‚¬ÄÂ¶ÄÂ°ÄÂ²ÄÂ°.',
        'HR' => 'Trenutno ne isporuÃ„Âujemo u ovu zemlju.',
        'RS' => 'ÄÂ¢Ã‘â‚¬ÄÂµÄÂ½Ã‘Æ’Ã‘â€šÄÂ½ÄÂ¾ ÄÂ½ÄÂµ ÄÂ¸Ã‘ÂÄÂ¿ÄÂ¾Ã‘â‚¬Ã‘Æ’Ã‘â€¡Ã‘Æ’Ã‘ËœÄÂµÄÂ¼ÄÂ¾ Ã‘Æ’ ÄÂ¾ÄÂ²Ã‘Æ’ ÄÂ·ÄÂµÄÂ¼Ã‘â„¢Ã‘Æ’.',
        'GR' => 'ÃÂ ÃÂÃÂ¿Ãâ€š Ãâ€ÃÂ¿ Ãâ‚¬ÃÂ±ÃÂÃÅ’ÃÂ½ ÃÂ´ÃÂµÃÂ½ ÃÂ±Ãâ‚¬ÃÂ¿ÃÆ’Ãâ€ÃÂ­ÃÂ»ÃÂ»ÃÂ¿Ãâ€¦ÃÂ¼ÃÂµ ÃÆ’ÃÂµ ÃÂ±Ãâ€¦Ãâ€ÃÂ® Ãâ€ÃÂ· Ãâ€¡ÃÂÃÂÃÂ±.',
        'SE' => 'Vi levererar fÃƒÂ¶r nÃƒÂ¤rvarande inte till detta land.',
        'NO' => 'Vi leverer for ÃƒÂ¸yeblikket ikke til dette landet.',
        'DK' => 'Vi leverer i ÃƒÂ¸jeblikket ikke til dette land.',
        'FI' => 'Emme tÃƒÂ¤llÃƒÂ¤ hetkellÃƒÂ¤ toimita tÃƒÂ¤hÃƒÂ¤n maahan.',
        'SA' => 'Ã™â€Ã˜Â§ Ã™â€ Ã™â€šÃ™Ë†Ã™â€¦ Ã˜Â­Ã˜Â§Ã™â€Ã™Å Ã˜Â§Ã™â€¹ Ã˜Â¨Ã˜Â§Ã™â€Ã˜Â´Ã˜Â­Ã™â€  Ã˜Â¥Ã™â€Ã™â€° Ã™â€¡Ã˜Â°Ã˜Â§ Ã˜Â§Ã™â€Ã˜Â¨Ã™â€Ã˜Â¯.',
        'AE' => 'Ã™â€Ã˜Â§ Ã™â€ Ã™â€šÃ™Ë†Ã™â€¦ Ã˜Â­Ã˜Â§Ã™â€Ã™Å Ã˜Â§Ã™â€¹ Ã˜Â¨Ã˜Â§Ã™â€Ã˜Â´Ã˜Â­Ã™â€  Ã˜Â¥Ã™â€Ã™â€° Ã™â€¡Ã˜Â°Ã˜Â§ Ã˜Â§Ã™â€Ã˜Â¨Ã™â€Ã˜Â¯.',
        'EG' => 'Ã™â€Ã˜Â§ Ã™â€ Ã™â€šÃ™Ë†Ã™â€¦ Ã˜Â­Ã˜Â§Ã™â€Ã™Å Ã˜Â§Ã™â€¹ Ã˜Â¨Ã˜Â§Ã™â€Ã˜Â´Ã˜Â­Ã™â€  Ã˜Â¥Ã™â€Ã™â€° Ã™â€¡Ã˜Â°Ã˜Â§ Ã˜Â§Ã™â€Ã˜Â¨Ã™â€Ã˜Â¯.',
        'IL' => 'Ã—ÂÃ—Â Ã—â€”Ã—Â Ã—â€¢ Ã—Å“Ã—Â Ã—ÂÃ—Â©Ã—Å“Ã—â€”Ã—â„¢Ã—Â Ã—â€ºÃ—Â¨Ã—â€™Ã—Â¢ Ã—Å“Ã—ÂÃ—â€œÃ—â„¢Ã—Â Ã—â€ Ã—â€“Ã—â€¢.',
        'IN' => 'Ã Â¤ÂµÃ Â¤Â°Ã Â¥ÂÃ Â¤Â¤Ã Â¤Â®Ã Â¤Â¾Ã Â¤Â¨ Ã Â¤Â®Ã Â¥â€¡Ã Â¤â€š Ã Â¤Â¹Ã Â¤Â® Ã Â¤â€¡Ã Â¤Â¸ Ã Â¤Â¦Ã Â¥â€¡Ã Â¤Â¶ Ã Â¤Â®Ã Â¥â€¡Ã Â¤â€š Ã Â¤Â¶Ã Â¤Â¿Ã Â¤ÂªÃ Â¤Â¿Ã Â¤â€šÃ Â¤â€” Ã Â¤Â¨Ã Â¤Â¹Ã Â¥â‚¬Ã Â¤â€š Ã Â¤â€¢Ã Â¤Â°Ã Â¤Â¤Ã Â¥â€¡ Ã Â¤Â¹Ã Â¥Ë†Ã Â¤â€šÃ Â¥Â¤',
        'TH' => 'Ã Â¸â€šÃ Â¸â€œÃ Â¸Â°Ã Â¸â„¢Ã Â¸ÂµÃ Â¹â€°Ã Â¹â‚¬Ã Â¸Â£Ã Â¸Â²Ã Â¹â€Ã Â¸Â¡Ã Â¹Ë†Ã Â¸Ë†Ã Â¸Â±Ã Â¸â€Ã Â¸ÂªÃ Â¹Ë†Ã Â¸â€¡Ã Â¹â€Ã Â¸â€ºÃ Â¸Â¢Ã Â¸Â±Ã Â¸â€¡Ã Â¸â€ºÃ Â¸Â£Ã Â¸Â°Ã Â¹â‚¬Ã Â¸â€”Ã Â¸Â¨Ã Â¸â„¢Ã Â¸ÂµÃ Â¹â€°',
        'VN' => 'HiÃ¡Â»â€¡n tÃ¡ÂºÂ¡i chÃƒÂºng tÃƒÂ´i khÃƒÂ´ng giao hÃƒÂ ng Ã„â€˜Ã¡ÂºÂ¿n quÃ¡Â»â€˜c gia nÃƒÂ y.',
...
function xepmarket2_localized_no_shipping_msg($msg)
{
    ...
    return '<div class="xep-no-shipping-notice" style="background: rgba(255, 69, 58, 0.08); border: 1px solid rgba(255, 69, 58, 0.25); border-radius: 12px; padding: 20px; text-align: center; margin: 15px 0;">
        <div style="font-size: 28px; margin-bottom: 8px;">ÄŸÅ¸Å¡Â«</div>
...
/**
 * Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
 * PLACE ORDER BUTTON Ã¢â‚¬â€ Disable until all required fields are filled
...
function xepmarket2_settings_page()
{
            ...
            <div class="xep-admin-container">
                ...
                <div class="xep-admin-content">
                        ...
                        <div class="xep-section-card">
                            ...
                            <div class="xep-form-group">
                                ...
                                <input type="text" name="xepmarket2_banner_discount"
                                    value="<?php echo esc_attr(get_option('xepmarket2_banner_discount', 'ÄŸÅ¸Å¡â‚¬ Limited Time Offer: Up to 50% OFF! ÄŸÅ¸Å¡â‚¬')); ?>" />
                        ...
                        <div class="xep-section-card" style="margin-top: 30px;">
                            ...
                            foreach ($required_plugins as $plug):
                                ...
                                if (isset($plug['type']) && $plug['type'] === 'core') {
                                    ...
                                    // GÃƒÂ¼ncelleme kontrolÃƒÂ¼: kurulu sÃƒÂ¼rÃƒÂ¼m < temadaki beklenen sÃƒÂ¼rÃƒÂ¼m
                                    $update_available = false;
                            ...
                            <div class="xep-form-group xep-custom-nav-item" style="border: 1px solid var(--admin-border); border-radius: 12px; padding: 14px; margin-top: 14px;">
                                ...
                                <div style="margin-top: 12px;">
                                    ...
                                    <select id="xep_custom_nav_page_<?php echo $ci; ?>" class="xep-page-select" data-url-id="xep_custom_nav_url_<?php echo $ci; ?>" data-label-id="xep_custom_nav_label_<?php echo $ci; ?>" data-icon-picker-for="xep_nav_custom_icon_<?php echo $ci; ?>" style="width: 100%; max-width: 320px; padding: 8px 10px; border-radius: 8px; border: 1px solid var(--admin-border); background: var(--admin-bg); color: var(--admin-text); margin-top: 4px;">
                                        <option value="" data-label="" <?php selected( empty($c['url']), true ); ?>>Ã¢â‚¬â€ Select a page Ã¢â‚¬â€</option>
                                        <?php
                        ...
                        <div class="xep-section-card">
                            ...
                            (function(){
                                ...
                                document.addEventListener('click',function(e){
                                    ...
                                    if(!confirm('Bu alanÃ„Â± silmek istediÃ„Å¸inizden emin misiniz?'))return;
                    ...
                    <div id="tab-alisync" class="xep-tab-content">
                        <div class="xep-section-card">
                            <h3 style="color: var(--admin-primary);"><i class="fas fa-sync-alt"></i> AliSync Helper <span style="font-size: 14px; font-weight: normal; opacity: 0.9;">Ã¢â‚¬â€ Stock &amp; price update</span></h3>
                    ...
                    <div id="tab-telegram" class="xep-tab-content">
                        <div class="xep-section-card">
                            ...
                            <div class="xep-form-group">
                                ...
                                <textarea name="xep_tg_bot_msg_new_order" class="xep-form-control" rows="5" style="resize: vertical;"><?php echo esc_textarea(get_option('xep_tg_bot_msg_new_order', "ÄŸÅ¸â€ºâ€™ <b>NEW ORDER</b>\n\n<b>Order:</b> #{order_id}\n<b>Customer:</b> {customer_name}\n<b>Total:</b> {total}\n<b>Items:</b>\n{items}")); ?></textarea>
                            </div>
                            <div class="xep-form-group">
                                <label>Status changed message</label>
                                <textarea name="xep_tg_bot_msg_status_changed" class="xep-form-control" rows="4" style="resize: vertical;"><?php echo esc_textarea(get_option('xep_tg_bot_msg_status_changed', "ÄŸÅ¸â€â€ <b>ORDER #{order_id}</b> Ã¢â€ â€™ {status}\n<b>Customer:</b> {customer_name}\n<b>Total:</b> {total}")); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab-affiliate" class="xep-tab-content">
                        <div class="xep-section-card">
                            ...
                            <p class="description" style="margin-bottom: 25px;">Referral commissions for completed orders. Users get a unique link from My Account Ã¢â€ â€™ Affiliate Dashboard. Full list and "Mark as paid": <a href="<?php echo esc_url(admin_url('admin.php?page=xepmarket2-affiliate')); ?>">WooCommerce Ã¢â€ â€™ Affiliates</a>.</p>
                            <div class="xep-form-group">
                        ...
                        <div class="xep-section-card">
                            ...
                            <div class="xep-grid-2">
                                ...
                                <div class="xep-form-group">
                                    ...
                                    <input type="password" name="xep_smtp_password" value="<?php echo esc_attr(get_option('xep_smtp_password')); ?>" placeholder="Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢" />
                                </div>
                            </div>
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            // Ã¢â€â‚¬Ã¢â€â‚¬ Multi-Step Plugin Installation Logic Ã¢â€â‚¬Ã¢â€â‚¬
            ...
            // Ã¢â€â‚¬Ã¢â€â‚¬ AJAX: Demo Import Ã¢â€â‚¬Ã¢â€â‚¬
            ...
            // Ã¢â€â‚¬Ã¢â€â‚¬ AJAX: Factory Reset Ã¢â€â‚¬Ã¢â€â‚¬
            ...
            // Ã¢â€â‚¬Ã¢â€â‚¬ AJAX: Save current state Ã¢â€â‚¬Ã¢â€â‚¬
            ...
            // Ã¢â€â‚¬Ã¢â€â‚¬ AJAX: Send Test Email Ã¢â€â‚¬Ã¢â€â‚¬
