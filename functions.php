...
// Ensure Affiliate is loaded before menus (admin and front) so My Account shows the link
...
// Define Theme Version: 1.9.0 for Cache Management & Portability
define('XEPMARKET_ALFA_VERSION', '1.9.0');
/**
