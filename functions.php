...
// Define Theme Version: 1.3.0for Cache Management & Portability
define('XEPMARKET_ALFA_VERSION', '1.3.0');
                ...
                <div class="xep-admin-content">
                    ...
                    <div id="tab-colors" class="xep-tab-content">
                        <div class="xep-section-card">
                            ...
                            <script>
                                function applyXep                                Preset(element, primary, secondary, bg, text, muted) {
                    ...
                    <div id="tab-checkout" class="xep-tab-content">
                        <div class="xep-section-card">
                                        ...
                                        <div style="display: flex; align-items: center; gap: 12px;">
                                            ...
                                            <div style="display: flex; align-items: center; gap: 5px; color: var(--text-muted); font-size: 12px;"
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="<?php echo esc_attr(get_option('xepmarket2_chk_order_' . $field_id, $field_data['order'])); ?>"
                                                    min="1" max="99"
                            ...
                            <script>
                                   (function () {
                                                var sortable = document.getElementById('xep_default_fields_                                                                                                                       sortable');
                                                    var dragEl = null;
