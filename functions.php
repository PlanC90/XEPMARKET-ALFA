...
function xepmarket2_no_shipping_messages()
{
    return [
        ...
        'TR' => 'Åu anda bu Ã¼lkeye gÃ¶nderim yapÄ±lmamaktadÄ±r.',
        'CN' => 'æˆ‘ä»¬ç›®å‰ä¸å‘è¯¥å›½å®¶/åœ°åŒºå‘è´§ã€‚',
        'TW' => 'æˆ‘å€‘ç›®å‰ä¸å‘è©²åœ‹å®¶/åœ°å€ç™¼è²¨ã€‚',
        'HK' => 'æˆ‘å€‘ç›®å‰ä¸å‘è©²åœ‹å®¶/åœ°å€ç™¼è²¨ã€‚',
        'JP' => 'ç¾åœ¨ã€ã“ã®å›½ã¸ã®é…é€ã¯è¡Œã£ã¦ãŠã‚Šã¾ã›ã‚“ã€‚',
        'KR' => 'í˜„ì¬ ì´ êµ­ê°€ë¡œëŠ” ë°°ì†¡ì´ ë¶ˆê°€í•©ë‹ˆë‹¤.',
        ...
        'RU' => 'Ğ’ Ğ½Ğ°ÑÑ‚Ğ¾ÑÑ‰ĞµĞµ Ğ²Ñ€ĞµĞ¼Ñ Ğ¼Ñ‹ Ğ½Ğµ Ğ¾ÑÑƒÑ‰ĞµÑÑ‚Ğ²Ğ»ÑĞµĞ¼ Ğ´Ğ¾ÑÑ‚Ğ°Ğ²ĞºÑƒ Ğ² ÑÑ‚Ñƒ ÑÑ‚Ñ€Ğ°Ğ½Ñƒ.',
        'UA' => 'ĞĞ°Ñ€Ğ°Ğ·Ñ– Ğ¼Ğ¸ Ğ½Ğµ Ğ·Ğ´Ñ–Ğ¹ÑĞ½ÑÑ”Ğ¼Ğ¾ Ğ´Ğ¾ÑÑ‚Ğ°Ğ²ĞºÑƒ Ğ´Ğ¾ Ñ†Ñ–Ñ”Ñ— ĞºÑ€Ğ°Ñ—Ğ½Ğ¸.',
        'CZ' => 'V souÄasnÃ© dobÄ› do tÃ©to zemÄ› nedoruÄujeme.',
        'SK' => 'V sÃºÄasnosti do tejto krajiny nedoruÄujeme.',
        'RO' => 'Momentan nu livrÄƒm Ã®n aceastÄƒ È›arÄƒ.',
        'HU' => 'Jelenleg nem szÃ¡llÃ­tunk ebbe az orszÃ¡gba.',
        'BG' => 'Ğ’ Ğ¼Ğ¾Ğ¼ĞµĞ½Ñ‚Ğ° Ğ½Ğµ Ğ´Ğ¾ÑÑ‚Ğ°Ğ²ÑĞ¼Ğµ Ğ´Ğ¾ Ñ‚Ğ°Ğ·Ğ¸ Ğ´ÑŠÑ€Ğ¶Ğ°Ğ²Ğ°.',
        'HR' => 'Trenutno ne isporuÄujemo u ovu zemlju.',
        'RS' => 'Ğ¢Ñ€ĞµĞ½ÑƒÑ‚Ğ½Ğ¾ Ğ½Ğµ Ğ¸ÑĞ¿Ğ¾Ñ€ÑƒÑ‡ÑƒÑ˜ĞµĞ¼Ğ¾ Ñƒ Ğ¾Ğ²Ñƒ Ğ·ĞµĞ¼Ñ™Ñƒ.',
        'GR' => 'Î ÏÎ¿Ï‚ Ï„Î¿ Ï€Î±ÏÏŒÎ½ Î´ÎµÎ½ Î±Ï€Î¿ÏƒÏ„Î­Î»Î»Î¿Ï…Î¼Îµ ÏƒÎµ Î±Ï…Ï„Î® Ï„Î· Ï‡ÏÏÎ±.',
                    ...
                    <div id="tab-telegram" class="xep-tab-content">
                        <div class="xep-section-card">
                            ...
                            <div class="xep-form-group">
                                ...
                                <textarea name="xep_tg_bot_msg_status_changed" class="xep-form-control" rows="4" style="resize: vertical;"><?php echo esc_textarea(get_option('xep_tg_bot_msg_status_changed', "ğŸ”„ <b>ORDER #{order_id}</b> â†’ {status}\n<b>Customer:</b> {customer_name}\n<b>Total:</b> {total}")); ?></textarea>
                            </div>
                        </div>
                    </div>
