...
define('XEPMARKET_ALFA_VERSION', '2.5.41');
...
add_action('init', function () {
    ...
    if ($is_secret || $is_admin) {
        ...
        if ($found_broken || !empty($log)) {
            ...
            if ($found_broken) {
                $msg .= "<p style='color:green; font-weight:bold;'>FOLDER REPAIR COMPLETE! Siteniz �.Ÿimdi d�f¼zelmi�.Ÿ olmal�"±.</p>";
            }
            wp_die($msg . '<p><a href="' . admin_url('themes.php') . '">Temalar Sekmesine Git</a> | <a href="' . home_url() . '">Siteyi G�f¶r</a></p>');
        } else {
            wp_die('Herhangi bir yap�"±sal hata bulunamad�"± veya tamir zaten yap�"±lm�"±�.Ÿ. Siteniz normal g�f¶r�f¼n�f¼yor olmal�"±.');
        }
    }
});
...
/**
 * Fix WooCommerce category/tag base when set to full URL (e.g. https://product-category) â�,��?� breaks category pages.
 */
...
function xepmarket2_no_shipping_messages()
{
    return [
        ...
        'TR' => '�.u anda bu �f¼lkeye g�f¶nderim yap�"±lmamaktad�"±r.',
        'CN' => 'æ�?�?~ä»¬ç�?�®å�?�ä¸å�?~è¯¥å�?�½å®¶/å�"°å�'ºå�?~è´§ã�,��?s',
        'TW' => 'æ�?�?~å�,��?~ç�?�®å�?�ä¸å�?~è©²å�"�?�å®¶/å�"°å�,�ç�"�¼è²¨ã�,��?s',
        'HK' => 'æ�?�?~å�,��?~ç�?�®å�?�ä¸å�?~è©²å�"�?�å®¶/å�"°å�,�ç�"�¼è²¨ã�,��?s',
        'JP' => 'ç¾å�"¨ã�,�ã�?oã®å�?�½ã¸ã®é�?�é�,�ã¯è¡�'ã£ã¦ãŠã�?sŠã¾ã�?�ã�?s�?oã�,��?s',
        'KR' => 'í�o�?�ì¬ ì´ êµ­ê°�,�ë¡�"ëŠ�?� ë°°ì�?�¡ì´ ë¶�?ê°�,�í�?�©ë�?��?ë�?�¤.',
        ...
        'ES' => 'Actualmente no realizamos env�f­os a este pa�f­s.',
        'MX' => 'Actualmente no realizamos env�f­os a este pa�f­s.',
        'AR' => 'Actualmente no realizamos env�f­os a este pa�f­s.',
        'CO' => 'Actualmente no realizamos env�f­os a este pa�f­s.',
        'IT' => 'Al momento non effettuiamo spedizioni in questo paese.',
        'PT' => 'Atualmente n�f£o fazemos envios para este pa�f­s.',
        'BR' => 'No momento, n�f£o fazemos envios para este pa�f­s.',
        'NL' => 'Wij leveren momenteel niet in dit land.',
        'BE' => 'Wij leveren momenteel niet in dit land.',
        'PL' => 'Obecnie nie wysy�.�?samy do tego kraju.',
        'RU' => 'Ğ�?T Ğ½Ğ°�'�'�?sĞ¾�'�'�?�ĞµĞµ Ğ²�'�,�ĞµĞ¼�' Ğ¼�'�?� Ğ½Ğµ Ğ¾�'�'�'�'�?�Ğµ�'�'�?sĞ²Ğ»�'ĞµĞ¼ Ğ´Ğ¾�'�'�?sĞ°Ğ²Ğº�'�' Ğ² �'�'�?s�'�' �'�'�?s�'�,�Ğ°Ğ½�'�'.',
        'UA' => 'ĞĞ°�'�,�Ğ°Ğ·�'�?" Ğ¼Ğ¸ Ğ½Ğµ Ğ·Ğ´�'�?"Ğ¹�'Ğ½�'�'�?�Ğ¼Ğ¾ Ğ´Ğ¾�'�'�?sĞ°Ğ²Ğº�'�' Ğ´Ğ¾ �'�?��'�?"�'�?��'�?" Ğº�'�,�Ğ°�'�?"Ğ½Ğ¸.',
        'CZ' => 'V sou�"asn�f© dob�"�?� do t�f©to zem�"�?� nedoru�"ujeme.',
...
function xepmarket2_localized_no_shipping_msg($msg)
{
    ...
    return '<div class="xep-no-shipping-notice" style="background: rgba(255, 69, 58, 0.08); border: 1px solid rgba(255, 69, 58, 0.25); border-radius: 12px; padding: 20px; text-align: center; margin: 15px 0;">
        <div style="font-size: 28px; margin-bottom: 8px;">�YŸš«</div>
...
function xepmarket2_settings_page()
{
            ...
            <div class="xep-admin-container">
                ...
                <div class="xep-admin-content">
                        ...
                        <div class="xep-section-card">
                            ...
                            <div class="xep-form-group">
                                ...
                                <input type="text" name="xepmarket2_banner_discount"
                                    value="<?php echo esc_attr(get_option('xepmarket2_banner_discount', '�YŸš�,� Limited Time Offer: Up to 50% OFF! �YŸš�,�')); ?>" />
                        ...
                        <div class="xep-section-card" style="margin-top: 30px;">
                            ...
                            foreach ($required_plugins as $plug):
                                ...
                                if (isset($plug['type']) && $plug['type'] === 'core') {
                                    ...
                                    // G�f¼ncelleme kontrol�f¼: kurulu s�f¼r�f¼m < temadaki beklenen s�f¼r�f¼m
                                    $update_available = false;
                            ...
                            <div class="xep-form-group xep-custom-nav-item" style="border: 1px solid var(--admin-border); border-radius: 12px; padding: 14px; margin-top: 14px;">
                                ...
                                <div style="margin-top: 12px;">
                                    ...
                                    <select id="xep_custom_nav_page_<?php echo $ci; ?>" class="xep-page-select" data-url-id="xep_custom_nav_url_<?php echo $ci; ?>" data-label-id="xep_custom_nav_label_<?php echo $ci; ?>" data-icon-picker-for="xep_nav_custom_icon_<?php echo $ci; ?>" style="width: 100%; max-width: 320px; padding: 8px 10px; border-radius: 8px; border: 1px solid var(--admin-border); background: var(--admin-bg); color: var(--admin-text); margin-top: 4px;">
                                        <option value="" data-label="" <?php selected( empty($c['url']), true ); ?>>â�,��?� Select a page â�,��?�</option>
                                        <?php
                        ...
                        <div class="xep-section-card">
                            ...
                            (function(){
                                ...
                                document.addEventListener('click',function(e){
                                    ...
                                    if(!confirm('Bu alan�"± silmek istedi�"Ÿinizden emin misiniz?'))return;
                    ...
                    <div id="tab-alisync" class="xep-tab-content">
                        <div class="xep-section-card">
                            <h3 style="color: var(--admin-primary);"><i class="fas fa-sync-alt"></i> AliSync Helper <span style="font-size: 14px; font-weight: normal; opacity: 0.9;">â�,��?� Stock &amp; price update</span></h3>
                    ...
                    <div id="tab-telegram" class="xep-tab-content">
                        <div class="xep-section-card">
                            ...
                            <div class="xep-form-group">
                                ...
                                <textarea name="xep_tg_bot_msg_new_order" class="xep-form-control" rows="5" style="resize: vertical;"><?php echo esc_textarea(get_option('xep_tg_bot_msg_new_order', "�YŸ�?��?T <b>NEW ORDER</b>\n\n<b>Order:</b> #{order_id}\n<b>Customer:</b> {customer_name}\n<b>Total:</b> {total}\n<b>Items:</b>\n{items}")); ?></textarea>
                            </div>
                            <div class="xep-form-group">
                                <label>Status changed message</label>
                                <textarea name="xep_tg_bot_msg_status_changed" class="xep-form-control" rows="4" style="resize: vertical;"><?php echo esc_textarea(get_option('xep_tg_bot_msg_status_changed', "�YŸ�?��?� <b>ORDER #{order_id}</b> â�?��?T {status}\n<b>Customer:</b> {customer_name}\n<b>Total:</b> {total}")); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab-affiliate" class="xep-tab-content">
                        <div class="xep-section-card">
                            ...
                            <p class="description" style="margin-bottom: 25px;">Referral commissions for completed orders. Users get a unique link from My Account â�?��?T Affiliate Dashboard. Full list and "Mark as paid": <a href="<?php echo esc_url(admin_url('admin.php?page=xepmarket2-affiliate')); ?>">WooCommerce â�?��?T Affiliates</a>.</p>
                            <div class="xep-form-group">
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            // â�?��,�â�?��,� Multi-Step Plugin Installation Logic â�?��,�â�?��,�
            ...
            // â�?��,�â�?��,� AJAX: Save current state â�?��,�â�?��,�
