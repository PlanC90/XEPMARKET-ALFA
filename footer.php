    ...
    <div class="container">
        <div class="footer-content" style="text-align: center; padding: 40px 0;">
            <div class="footer-brand" style="margin-bottom: 40px;">
                ...
                ?>
                <span class="logo-text" style="font-size: 28px;">
            ...
            <div class="footer-info" style="border-top: 1px solid var(--border-glass); padding-top: 30px;">
                <p style="color: var(--text-muted); font-size: 14px; margin-bottom: 20px;">
                    &copy; 2026 XEPmarket.com. Built on
                    ...
                    <a href="https://memextoken.org" target="_blank"
                        style="color: var(--primary); text-decoration: none; font-weight: 600;">MEMEXAI</a>
                </p>
